...
__all__ = ["BaseModel_contrastive_noLong"]


class BaseModel_Contrastive_noLong:
    def __init__(self, hparams, iterator_creator, graph=None, seed=None):
        ...
        with self.graph.as_default():
            ...
            self.logit_pos, self.loss_cosine = self._build_graph()
    ...
    def _get_lossA(self):
        ...
        # self.lossA = tf.add(self.lossA, self.bpr_loss)
        # self.lossA = tf.add(self.lossA, self.loss_cosine_long)
    ...
    #     l2_loss = tf.add(
    #         l2_loss, tf.multiply(regular_para * int(components[2]), tf.nn.l2_loss(self.logit_pos - self.logit_neg))
    #     )
