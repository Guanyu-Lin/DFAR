...
__all__ = ["SASRecFactorizationModel"]


class SASRecFactorizationModel(SequentialBaseModel):
...
#
    def _build_seq_graph(self):
        ...
        with tf.name_scope('sasrec'):
            ...
            # self.real_mask_np = self.real_mask.eval(self.sess)
            ...
            # self.num_heads = 
            # self.mask_matrix = np.zeros((1, self.num_heads, max_len, max_len, self.num_heads))

            # for i in range(max_len):
            #     for j in range(max_len):
            #         print(self.mask_matrix[0, int(self.real_mask_np[i] * self.num_heads / 2) : int((self.real_mask_np[i] + 1) * self.num_heads / 2), i, j, int(self.real_mask_np[j] * self.num_heads / 2) : int((self.real_mask_np[j] + 1) * self.num_heads / 2)])
